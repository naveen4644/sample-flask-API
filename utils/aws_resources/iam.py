import boto3
import json
from values import ECS_TASK_POLICY_DESC, ECS_TASK_POLICY_ARN, ECS_TASK_POLICY_JSON, ECS_TASK_POLICY_NAME, ECS_TASK_ROLE_JSON, ECS_TASK_ROLE_NAME, ECS_TASK_ROLE_DESC
